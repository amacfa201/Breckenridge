...
public class bookScript : MonoBehaviour
{
    ...
    public GameObject bookUIObject; // Actually Margaret's book UI is set here
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && !isOpening)
        {
            ...
            if (bookUIObject.activeInHierarchy == true)
            {
                x = 1;
            }
    ...
    IEnumerator False()
    {
        ...
        isOpening = true;
        cameraScript.anyBooksOpen = true;
        ...
        other.ShowCamera(bookUIObject );
        Updater.SetActive(true);
        yield return new WaitForSeconds(openingDelay);
        cameraScript.anyBooksOpen = false;
        isOpening = false;
    }
